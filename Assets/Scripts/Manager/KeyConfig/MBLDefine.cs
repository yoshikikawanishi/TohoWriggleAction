...
namespace MBLDefine {
    ...
    internal sealed class Key : InputValue {
        ...
        public static readonly Key Shot = new Key("Shot", new List<KeyCode> { KeyCode.X , KeyCode.Joystick1Button1 });
        public static readonly Key Jump = new Key("Jump", new List<KeyCode> { KeyCode.Z , KeyCode.Joystick1Button3 });
        public static readonly Key Fly = new Key("Fly", new List<KeyCode> { KeyCode.LeftShift , KeyCode.Joystick1Button6 });
