...
public class BulletScrollPoolFunctions : MonoBehaviour {
    ...
    public void Shoot_Bullet(Vector2 velocity, float lifeTime) {
        ...
        shoot_Bullet.transform.SetParent(main_Camera.transform);
    ...
    public void Turn_Shoot_Bullet(float speed, float angle, float lifeTime) {
        ...
        turn_Bullet.transform.SetParent(main_Camera.transform);
    ...
    public void Odd_Num_Bullet(int num, float angle, float speed, float lifeTime) {
        ...
        if (player != null) {
            for (int i = 0; i < num; i++) {
                ...
                odd_Bullet.transform.SetParent(main_Camera.transform);
    ...
    public void Even_Num_Bullet(int num, float angle, float speed, float lifeTime) {
        ...
        if (player != null) {
            for (int i = 0; i < num; i++) {
                ...
                even_Bullet.transform.SetParent(main_Camera.transform);
